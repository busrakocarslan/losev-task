...
export default function Hero() {
  ...
  const personSchema = {
    ...
    "sameAs": [
      "https://linkedin.com/in/busrakocarslan",
      "https://github.com/busrakocarslan"
    ],
    "knowsAbout": [
      "React",
      "Next.js",
    ...
    "colleague": {
      "@type": "Person",
      "name": "Beray",
      "jobTitle": "Avukat ve Yazılım Danışmanı"
    }
  };
  ...
  return (
    <><script
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify(personSchema) }} /><section id="about" className="pt-24 pb-16 min-h-screen flex items-center relative bg-white dark:bg-gray-800">
        <AnimatedBacground
